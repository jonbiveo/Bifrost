...
lazy val eventTree = project
  ...
  .settings(scalamacrosParadiseSettings)
  .dependsOn(models, typeclasses, algebras, commonInterpreters)
...
lazy val commonInterpreters = project
  ...
  .settings(libraryDependencies ++= Dependencies.test ++ Dependencies.catsEffect ++ Seq(Dependencies.akka("actor-typed")) ++ Dependencies.levelDb)
  .settings(scalamacrosParadiseSettings)
...
lazy val demo = project
  ...
  .settings(scalamacrosParadiseSettings)
  .dependsOn(models, typeclasses, consensus, minting, eventTree)
